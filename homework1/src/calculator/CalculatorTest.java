...
//        ).isInstanceOf(IllegalStateException.class);
        ...
        // Проверка функции вычисления скидки

        assertThat(Calculator.calculatingDiscount(100, 25)).isEqualTo(25);
        // Проверка функции вычисления скидки на выброс исключения при введении процента скидки больше 100
        assertThatThrownBy(() -> Calculator.calculatingDiscount(100,101))
                .isInstanceOf(ArithmeticException.class);
        // Проверка на выброс исключения при введении суммы покупки и процента скидки меньше 0
